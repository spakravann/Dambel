...
import com.faraa.sohrabpakravan.dambel.Activities.MovesVideoPlayerActivity;
...
public class ExerciseAdapter extends RecyclerView.Adapter<ExerciseAdapter.MyViewHolder> {
    ...
    public ExerciseAdapter(Context context, ArrayList<MoveImageData> _moveImageList) {
    ...
    @Override
    public ExerciseAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                            int viewType) {
        // create a new view
        ...
        MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(mContext, MovesVideoPlayerActivity.class);
